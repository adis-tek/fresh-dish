...
function LogIn() {
    ...
    <Container>
        ...
        <Account>Forgot your password? <br></br><Link to="/forgot-password" style={{color:'white'}}>Change password</Link></Account>
        <UpdateAccount>Or <Link to="/update-profile" style={{color:'white'}}>Update Account</Link></UpdateAccount>
        </FormContainer>
    </Container>
    )
};
